  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['Creative flow', 'Café ambience or nature at a lively level, with an optional ten-minute warm-up of upbeat instrumental music first (tick Warm-up first in the Session window).', 'Ideation runs on moderate arousal, and dead silence leaves it flat.', 'Dead silence, volume past Café.'],
